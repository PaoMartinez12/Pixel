...
<body>
  ...
  <header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center">
      ...
      <h1><a href="index.html" class="logo mr-auto"><img src="{{asset('/img/logo.png')}}" alt="" class="img-fluid">Pixel</a></h1>
      ...
      <div class="row">
        ...
        <div class="col-lg-6 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1" data-aos="fade-up" data-aos-delay="200"><br><br>
          ...
          <ul style="color: white;">
            <li>MIDDLEWARE</li>
            <ol>  Lightweight and scaleable to no limitations</ol>
            <li>APPLICATION PLAYER </li>
            <ol>Advanced player for any screen size.</ol>
