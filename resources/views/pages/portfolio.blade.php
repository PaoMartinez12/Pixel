...
<section id="portfolio" class="portfolio-mf sect-pt4 route">
  <div class="container">
    ...
    <div class="row">
      <div class="col-md-4">
        <div class="work-box">
          <a href="{{asset('img/catalogo/work-1.jpg')}}" data-gall="portfolioGallery" class="venobox">
            <div class="work-img">
              <img src="{{asset('img/catalogo/work-1.jpg')}}" alt="" class="img-fluid">
            </div>
          </a>
      ...
      <div class="col-md-4">
        <div class="work-box">
          <a href="{{asset('img/catalogo/work-2.jpg')}}" data-gall="portfolioGallery" class="venobox">
            <div class="work-img">
              <img src="{{asset('img/catalogo/work-2.jpg')}}" alt="" class="img-fluid">
            </div>
          </a>
          <div class="work-content">
            <div class="row">
      ...
      <div class="col-md-4">
        <div class="work-box">
          <a href="{{asset('img/catalogo/work-3.jpg')}}" data-gall="portfolioGallery" class="venobox">
            <div class="work-img">
              <img src="{{asset('img/catalogo/work-3.jpg')}}" alt="" class="img-fluid">
            </div>
          </a>
          <div class="work-content">
            <div class="row">
      ...
      <div class="col-md-4">
        <div class="work-box">
          <a href="{{asset('img/catalogo/work-4.jpg')}}" data-gall="portfolioGallery" class="venobox">
            <div class="work-img">
              <img src="{{asset('img/catalogo/work-4.jpg')}}" alt="" class="img-fluid">
            </div>
          </a>
          <div class="work-content">
            <div class="row">
      ...
      <div class="col-md-4">
        <div class="work-box">
          <a href="{{asset('img/catalogo/work-5.jpg')}}" data-gall="portfolioGallery" class="venobox">
            <div class="work-img">
              <img src="{{asset('img/catalogo/work-5.jpg')}}" alt="" class="img-fluid">
            </div>
          </a>
          <div class="work-content">
            <div class="row">
      ...
      <div class="col-md-4">
        <div class="work-box">
          <a href="{{asset('img/catalogo/work-6.jpg')}}" data-gall="portfolioGallery" class="venobox">
            <div class="work-img">
              <img src="{{asset('img/catalogo/work-6.jpg')}}" alt="" class="img-fluid">
            </div>
          </a>
          <div class="work-content">
            <div class="row">
